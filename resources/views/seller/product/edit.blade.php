...
<div class="card">
    ...
    <div class="card-body">
      <form method="post" action="{{route('seller_product.update',$product->id)}}" enctype="multipart/form-data">
        @csrf 
        @method('PATCH')
        ...
        <div class="form-group">
          <label for="price" class="col-form-label">Price Offer <span class="text-danger">*</span></label>
          <input id="price" type="number" name="price_offer" placeholder="Enter price"  value="{{$product->price_offer}}" class="form-control">
          @error('price_offer')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>

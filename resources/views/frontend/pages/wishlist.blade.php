				...
				<div class="col-12">
					...
					<table class="table shopping-summery">
						...
						<tbody>
							...
							@if(Helper::getAllProductFromWishlist()->count()>0)
								...
								@foreach(Helper::getAllProductFromWishlist() as $key=>$wishlist)
									<tr>
										...
										<td class="product-des" data-title="Description">
											<p class="product-name"><a href="{{route('product.details',$wishlist->product['slug'])}}">{{$wishlist->product['title']}}</a></p>
							...
							@else 
								<tr>
									<td class="text-center">
										There are no any wishlist available. <a href="{{route('index')}}" style="color:blue;">Continue shopping</a>

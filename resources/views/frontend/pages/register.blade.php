...
@section('title','Navigly || Register Page')
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="full_name" placeholder="fullname" required="required" value="{{old('full_name')}}">
                                        @error('full_name')
                                ...
                                <div class="col-12">
                                    <div class="form-group login-btn">
                                        ...
                                        <a href="{{route('login.submit')}}" class="btn">Login</a>
                                        OR

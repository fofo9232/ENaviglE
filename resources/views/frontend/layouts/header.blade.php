			...
			<div class="container">
				<div class="row">
					<div class="col-lg-4 col-md-12 col-12">
						...
						<div class="top-left">
							<ul class="list-main">
								<li><i class="ti-headphone-alt"></i> {{get_setting('phone')}}</li>
								<li><i class="ti-email"></i> support@navigly.com</li>
							</ul>
						</div>
						<!--/ End Top Left -->
					</div>
					<div class="col-lg-8 col-md-12 col-12">
						...
						<div class="right-content">
							<ul class="list-main">     
                                ...
                                @else 
                                    <li><i class="ti-user"></i> <a href="{{route('index')}}"  target="_blank">Dashboard</a></li>
                                @endif
            ...
            <div class="row">
                <div class="col-lg-2 col-md-2 col-12">
                    ...
                    <div class="logo">
                        ...
                        <a href="{{route('index')}}"><img src="{{get_setting('logo')}}" alt="logo" width="100"></a>
                    </div>
                    <!--/ End Logo -->
                    <!-- Search Form -->
                                        ...
                                        {{-- {{Helper::getAllProductFromCart()}} --}}
                                            @foreach(Helper::getAllProductFromWishlist() as $data)
                                                    ...
                                                    <li>
                                                        ...
                                                        <h4><a href="{{route('product.details',$data->product['slug'])}}" target="_blank">{{$data->product['title']}}</a></h4>

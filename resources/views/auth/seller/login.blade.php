...
<head>
  <title> {{get_setting('title')}} || Login Page</title>
      ...
      <div class="col-xl-10 col-lg-12 col-md-9 mt-5">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="row">
              <div class="col-lg-6 d-none d-lg-block bg-login-image"><img src="{{asset(get_setting('logo'))}}"  width=500px ></div>
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4"> Enter your Seller Account</h1>
                  </div>
